    ...
    (cond
      ...
      [else
       ...
       (cond
         [(not selected) resp]
         [else
          (compress-response resp selected zstd-level brotli-quality brotli-window brotli-mode)])])))

(define (compress-response resp encoding zstd-level brotli-quality brotli-window brotli-mode)
